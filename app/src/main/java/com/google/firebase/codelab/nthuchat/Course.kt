    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        mFirebaseAdapter = object : FirebaseRecyclerAdapter<FriendlyMessage, Course.MessageViewHolder>(options) {
            override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): Course.MessageViewHolder {
                ...
                when (i) {
                    0 -> return Course().MessageViewHolder(inflater.inflate(R.layout.item_message, viewGroup, false))
                    1 -> return Course().MessageViewHolder(inflater.inflate(R.layout.item_message_me, viewGroup, false))
                    else -> return Course().MessageViewHolder(inflater.inflate(R.layout.item_message, viewGroup, false))
                }
            }
